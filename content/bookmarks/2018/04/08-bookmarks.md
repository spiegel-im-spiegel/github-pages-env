...
- [Chromeの暗号通貨マイニング拡張機能は全面禁止――Google、Chrome Web Storeの規約改定  |  TechCrunch Japan](https://techcrunch.com/2018/04/02/google-is-banning-all-cryptomining-extensions-from-its-chrome-web-store/)
...
- [フリーランス・ライターに便利な自動ポートフォリオ作成ツール  |  TechCrunch Japan](https://techcrunch.com/2018/03/30/cv-portfolios/)
