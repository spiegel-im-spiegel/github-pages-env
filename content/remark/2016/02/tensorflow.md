...
- [TensorFlowライブラリによる機械学習モデルの、本番アプリケーションへの実装を助けるAPI集TensorFlow ServingをGoogleがリリース | TechCrunch Japan](https://techcrunch.com/2016/02/16/google-makes-it-easier-to-take-machine-learning-models-into-production/)
