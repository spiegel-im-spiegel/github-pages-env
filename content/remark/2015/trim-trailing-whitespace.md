+++
date = "2015-11-23T10:28:56+09:00"
...
おまけだが，同じ Setting で “Ensure Single Trailing Newline” を有効にすると，テキストファイル末尾が改行になっていない場合は改行を補ってくれる。
...
ちなみに同様の手順は[サクラエディタ]でも使える[^b] （実は [ATOM] でも使える）。
