...
自宅から[ノート PC]({{< ref "/remark/2024/05/get-a-used-pc-from-workplace.md" >}} "勤務先からの払い下げ PC") を持ってきてもらったが，それなりに場所を取るし，特にリハビリ中などは貴重品入れにしまっておく必要があるので常時広げておくわけにはいかないので，実際にはあまり使わなかった。
...
過去に「おすすめ」や「ブックマーク」したポストの確認とそこから発生する調べものは Web ブラウザで。
