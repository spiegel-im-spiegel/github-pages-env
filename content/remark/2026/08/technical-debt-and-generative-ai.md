...
まぁ，個々のエンジニアについては（特に年配者は）適応できない人もいるだろうし（そっと耳を塞ぐ），本当に AI 導入を理由にエンジニアを解雇するバカな経営者も（特に米国では）いるみたいだが[^w1]。
...
Web 上の技術関連のサイトやページを眺めても，そこに言及する記事はほとんど見かけない。
まぁ，そこが本当の意味で「技術（＝お金を取れるところ）」だからなんだろうけど。
