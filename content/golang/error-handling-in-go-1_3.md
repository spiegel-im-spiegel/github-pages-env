...
さて， [Go 言語]コンパイラの 1.3 がリリースされた（2019-08-22 時点ではリリース候補版）。

[Go] 1.3 の変更点は色々あるが，エラー・ハンドリングに関しては「エラーの構造化」が正式に組み込まれたことだろう。
...
まぁ “When” や “Who” は寧ろ logger の担当だろうけど。
