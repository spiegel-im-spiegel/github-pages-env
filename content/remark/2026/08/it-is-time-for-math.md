...
と残りのケースも成り立つことが分かる（直前の合同式の結果を用いて計算していることに注目）。
これにより，0以上の任意の整数 $k$ に対して
