...
[前回]著作権についてざくっと説明したので，今回はいよいよ Creative Commons Licenses （以降 “[CC Licenses]” と略称する）について解説する。
...
「クレジット」「同等のライセンス」「営利/非営利」については後ほど解説する。
...
許諾者はマテリアルに付与したライセンスを取消しできない。
したがって，少なくともライセンスの条件を守っていればマテリアルの利用を取消されることはない[^c]。
...
- マテリアルおよびその複製について，著作権表示を改変・削除すること
- マテリアルおよびその複製について，ライセンスおよびその条件を変更すること
- マテリアルの正当な使用または許可された利用を制限する技術的保護手段を用いること
