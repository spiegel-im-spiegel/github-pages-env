...
[^oss]: もっと言うと「時代に合わせて適宜入れ替えを行える」ことが商業システムにおける FOSS の大きなメリットなんだよ。これは「それらを容易にするための戦略は、できるだけ長い期間、できるだけ多くの選択肢を残すことである」（『[Clean Architecture](https://www.amazon.co.jp/dp/B07FSBHS2V?tag=baldandersinf-22&linkCode=ogi&th=1&psc=1)』より）というアーキテクチャ設計本来の目的とも合致する。バグや脆弱性を含めて，自分たちに都合が悪くなったからといって微塵も貢献していない FOSS 製品に文句を言って「直させる」のは根底から間違っている。「文句があるならコードをくれ！」だ。
