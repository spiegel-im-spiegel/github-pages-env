...
使い捨ての鍵ペアを使う ephemeral な DH や ECDH では「なりすまし」の問題があるため，ユーザとホストの間での相互認証がどうしても必要となるが，上のリンク先の記事を見る限り，そういう認証（authentication）とは違うっぽい？

それはともかく，ホスト認証に使える電子署名アルゴリズムはクライアント認証で使う暗号スイートと同じようだ。
