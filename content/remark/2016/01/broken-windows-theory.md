+++
date = "2016-01-06T12:38:03+09:00"
description = "結局これは他の犯罪と同じで，「割れ窓」をせっせと補修して回ってもきりがなく，犯罪を起こす動機（incentive）を減らしていくことこそが本命なのである。"
draft = true
...
メリケンのインテリよりも古代人の言葉のほうが「深い」というのはなかなか皮肉が効いている。

[^bw]: 「割れ窓理論」では米国ニューヨーク市警の事例が有名だろう（以下要補足）。
...
はっきり言って（最初期の頃はともかく）ボットネット・テイクダウンを続けても劇的な効果を示すとは思えない。
むしろテイクダウンに係るコストを浪費させることが攻撃者にとって意味があると言える（テロと同じ）。
...
結局これは他の犯罪と同じで，「割れ窓」をせっせと補修して回ってもきりがなく，犯罪を起こす動機（incentive）を減らしていく[^0] ことこそが本命なのである。
