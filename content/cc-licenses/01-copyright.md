...
かつての出版特許との違いは，著作権が，著作者と出版社，著作者と著作者，出版社と出版社，の間のパワーバランスを図る手段として機能し始めたことである。

ただ，この時点でもまだユーザは著作・出版のプレイヤーではなかった。
というか，割と最近までユーザは著作権システムの埒外であった。
これが数十年前くらいから変わってきた。

変化のひとつは，プログラムコードを「著作物」として含めたことにより著者とユーザの区別が曖昧になり「独占 vs 自由」の抗争が本格化してきたこと。
...
具体的に著作物とは何を指すかというと，以下に挙げられるものである（[著作権法] 第10条から12条）。
...
憲法その他の法令，国または地方公共団体等が発する告示・訓令・通達，裁判所の判決・決定・命令など，およびその翻訳物や編集物（国または地方公共団体等が作成するもの）は著作権の対象としての「著作物」とはみなされない（[著作権法] 第13条）

「二次的著作物」については別の記事で改めて紹介する。

### 「著作者」とは

「著作者」は著作物を創作する者（[著作権法] 第2条）である。
以上。
...
- 出版権（「複製権等保有者」が「出版」を引き受ける者に対して設定する権利で，権利者は出版の義務を伴う）
    - 複製権（[著作権法] 第80条）
    - 公衆送信権（[著作権法] 第80条）
...
その他の著作物については著作者の死後50年までの期限が設けられているが，いろいろと例外がある。
現在 TPP においてその期限を70年まで引き上げようとしているのはご存知のとおりである。

[^h]: ただし，人格権の侵害があったとしても，それが本当に著作者にとって害になるかどうかは考慮されるらしい。

## ユーザから見た著作権

著作権は著作物に対するあらゆる行為を禁止しているわけではない。
たとえば「本を読む」「音楽を聞く」「映画を観る」といった行為は禁止されない。
こういった行為を著作物の「使用」と呼ぶ。

一方，上述した権利にまつわる行為を「利用」と呼び，既定では禁止されている。
著作権者は「利用」を許諾する「権利」を持っている，のである。
...
しかし，時代や価値観が大きく変化している真っ最中の現代において，日本のやりかたが「遅きに失している」ことは否めない。

### 「共有」のためのライセンス

ユーザが分からみた場合，「法」が整備されていくのを悠長に待っている訳にはいかない。
