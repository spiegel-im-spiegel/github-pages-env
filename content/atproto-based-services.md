...
[Bridgy Fed] は [Bluesky] と [Mastodon] を連携させるサービスで，現在 Bluesky → Mastodon と Mastodon → Bluesky のブリッヂが提供されている。
また Web サイトを [Bluesky] および [Mastodon] と連携させる機能も提供されている。
